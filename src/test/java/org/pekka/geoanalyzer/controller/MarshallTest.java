...
public class MarshallTest {
    ...
    @Autowired
    JacksonTester<GeoDataArray> tester;
    ...
    void marshallGeoDataArray() throws IOException {
        ...
        // When
        ObjectContent<GeoDataArray> content = tester.parse(bytes);
        // Then
        content.assertThat().isInstanceOf(GeoDataArray.class);
        content.assertThat().asInstanceOf(InstanceOfAssertFactories.type(GeoDataArray.class)).satisfies(geoDataArray -> {
